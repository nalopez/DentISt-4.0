...
class ViewMedAndSocHistoVersions extends CI_Controller {
		...
		if($this->session->userdata('logged_in'))
   		{
			...
			if($bool){
				...
				$id = $session_data['id'];
	   			...
	   			$data2['version'] = $this->patient->getMedAndSocHistoVersions($id);
				...
				$this->load->view('viewmedandsochistoversions_view', $data2);
			}
			else{
