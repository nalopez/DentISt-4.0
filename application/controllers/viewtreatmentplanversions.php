...
class ViewTreatmentPlanVersions extends CI_Controller {
		...
		if($this->session->userdata('logged_in'))
   		{
			...
			if($bool){
				...
				$id = $session_data['id'];
	   			...
	   			$data2['version'] = $this->patient->getTreatmentPlanVersions($id);
				...
				$this->load->view('viewtreatmentplanversions_view', $data2);
			}
			else{
