...
class ViewPatientChecklistVersions extends CI_Controller {
		...
		if($this->session->userdata('logged_in'))
   		{
			...
			if($bool){
				...
				$id = $session_data['id'];
	   			...
	   			$data2['version'] = $this->patient->getPatientChecklistVersions($id);
				...
				$this->load->view('viewpatientchecklistversions_view', $data2);
			}
			else{
