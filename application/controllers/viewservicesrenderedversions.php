...
class ViewServicesRenderedVersions extends CI_Controller {
		...
		if($this->session->userdata('logged_in'))
   		{
			...
			if($bool){
				...
				$id = $session_data['id'];
	   			...
	   			$data2['version'] = $this->patient->getServicesRenderedVersions($id);
				...
				$this->load->view('viewservicesrenderedversions_view', $data2);
			}
			else{
