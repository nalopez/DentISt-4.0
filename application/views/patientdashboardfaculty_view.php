...
<div class="maindiv" style="border:0px;">
	...
	<center>
		...
		<?php 
			$section = "";
			$ptnt = $this->patient->getSection($id);
			foreach($ptnt as $row){
 		...
 		?>
			...
			<table>
				<tr>
					<td><input type="checkbox" name="sctn[]" id="patientinfocb" value="Patient Information" onClick="visibility(this.id)"> Patient Information 
					<td><div id="patientinfodiv" style="display:none;"><textarea name="patientinfotxt" cols="30"></textarea></div>
				</tr>
				<tr>
					<td><input type="checkbox" name="sctn[]" id="patientchecklistcb" value="Patient Checklist" onClick="visibility(this.id)"> Patient Checklist 
					<td><div id="patientchecklistdiv" style="display:none;"><textarea name="patientchecklisttxt" cols="30"></textarea></div>
				</tr>
				<tr>
					<td><input type="checkbox" name="sctn[]" id="medandsochistocb" value="Medical & Social History" onClick="visibility(this.id)"> Medical & Social History 
					<td><div id="medandsochistodiv" style="display:none;"><textarea name="medandsochistotxt" cols="30"></textarea></div>
				</tr>
				<tr>
					<td><input type="checkbox" name="sctn[]" id="dentaldatacb" value="Dental Data" onClick="visibility(this.id)"> Dental Data 
					<td><div id="dentaldatadiv" style="display:none;"><textarea name="dentaldatatxt" cols="30"></textarea></div>
				</tr>
				<tr>
					<td><input type="checkbox" name="sctn[]" id="dentalchartcb" value="Dental Status Chart" onClick="visibility(this.id)"> Dental Status Chart
					<td><div id="dentalchartdiv" style="display:none;"><textarea name="dentalcharttxt" cols="30"></textarea></div> 
				</tr>
				<tr>
					<td><input type="checkbox" name="sctn[]" id="treatmentplancb" value="Treatment Plan" onClick="visibility(this.id)"> Treatment Plan
					<td><div id="treatmentplandiv" style="display:none;"><textarea name="treatmentplantxt" cols="30"></textarea></div>
				</tr>
			</table><br>

			<input type="button" name="Save" value="Save Remarks" onClick="decide('Temporary')">&nbsp;<input type="button" name="Approve" value="Approve" onClick="decide('Approved')">&nbsp;<input type="button" name="Reject" value="Reject" onClick="decide('Rejected')">
		</form>
	</center>
