...
<link href="<?php echo base_url(); ?>css/ui-lightness/jquery-ui-1.10.3.custom.css" rel="stylesheet">
   ...
   <title>Patient Checklist - View Versions</title>
...
<div align="left"><br><a href="<?php echo base_url();?>index.php/patientchecklist/patient/<?php echo $id; ?>"> Go Back </a></div><br>

	<table aling="center" class="altcolor" style="width:98%; left:1%; text-align: center;">
		<tr class="header">
			<td colspan=6> Patient Checklist Versions
		</tr>
		<tr>
			<td><b>Version</b>
			<td><b>Updated By</b>
		...
		<?php 	if($version){
				...
				foreach($version as $row){
					echo "<tr><td><a href=".base_url()."index.php/patientchecklist/view/".$row['UPCD_ID']."/".$row['patientchecklistversionID'].">"."Version ".$ctr."</a>";
