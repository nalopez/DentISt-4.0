...
//end of redraw
		function drawDivision(x) {	ctx61.strokeStyle = "#D9D9D9";	ctx61.moveTo(0, 125);	
		ctx61.lineTo(1261, 125);	ctx61.stroke();	ctx61.moveTo(x, 0);	ctx61.lineTo(x, 250);	
		ctx61.stroke();
		}
		
		function drawCrowns(x, y, ctx1, ctx2) {	additional = 2/thisarray2[index].length;	for(var i = 0; i < thisarray2[index].length; i++) {		ctx1.beginPath();		ctx1.arc(x, y, 35, (2-(thisarray2[index].length-i)*additional)*Math.PI, Math.PI*2, false);		ctx1.lineTo(x,y);		ctx1.closePath();		ctx1.fillStyle=arrayFillColor2[index][i];		ctx1.fill();				ctx2.beginPath();		ctx2.arc(x, y, 14 ,(2-(thisarray2[index].length-i)*additional)*Math.PI, Math.PI*2, false);		ctx2.lineTo(x,y);		ctx2.closePath();		ctx2.fillStyle=arrayFillColor2[index][i];		ctx2.fill();	}}
		var X;var Y;
		function getXval(toothnumber) {	var space = 10;	if((toothnumber == 18) || (toothnumber == 48)){		var toothvalue = 1;		x = toothvalue * 65;	}	else {		if((toothnumber == 17) || (toothnumber == 47)) {			toothvalue = 2;		}		if((toothnumber == 16) || (toothnumber == 46)) {			toothvalue = 3;		}		if((toothnumber == 15) || (toothnumber == 45)) {			toothvalue = 4;		}		if((toothnumber == 14) || (toothnumber == 44)) {			toothvalue = 5;		}		if((toothnumber == 13) || (toothnumber == 43)) {			toothvalue = 6;		}		if((toothnumber == 12) || (toothnumber == 42)) {			toothvalue = 7;		}		if((toothnumber == 11) || (toothnumber == 41)) {			toothvalue = 8;		}		if((toothnumber == 21) || (toothnumber == 31)) {			toothvalue = 9;		}		if((toothnumber == 22) || (toothnumber == 32)) {			toothvalue = 10;		}		if((toothnumber == 23) || (toothnumber == 33)) {			toothvalue = 11;		}		if((toothnumber == 24) || (toothnumber == 34)) {			toothvalue = 12;		}		if((toothnumber == 25) || (toothnumber == 35)) {			toothvalue = 13;		}		if((toothnumber == 26) || (toothnumber == 36)) {			toothvalue = 14;		}		if((toothnumber == 27) || (toothnumber == 37)) {			toothvalue = 15;		}		if((toothnumber == 28) || (toothnumber == 38)) {			toothvalue = 16;		}		x = toothvalue * 65 + space * (toothvalue-1);	}	X = x;}
		function getYval(toothnumber) {	if((toothnumber >= 11)&&(toothnumber <= 28)) {		y = 65;	}	else if ((toothnumber >= 31)&&(toothnumber <= 48)) {		y = 185;	}	Y = y;}
		
		function getFormid(toothnumber) {restoreTypeSelectid = "restoreTypeSelect" + toothnumber;	cariesSelectid = "cariesSelect" + toothnumber; recurrentSelectid = "recurrentSelect" + toothnumber; cariesSelectSurfaceid = "cariesSelectSurface" + toothnumber; recurrentSelectSurfaceid = "recurrentSelectSurface" + toothnumber;	distalformid = "distal" + toothnumber;	buccalformid = "buccal" + toothnumber;	mesialformid = "mesial" + toothnumber;	lingualformid = "lingual" + toothnumber;	occlusalformid = "occlusal" + toothnumber;		redistalformid = "redistal" + toothnumber;	rebuccalformid = "rebuccal" + toothnumber;	remesialformid = "remesial" + toothnumber;	relingualformid = "relingual" + toothnumber;	reocclusalformid = "reocclusal" + toothnumber;		restodistalformid = "restodistal" + toothnumber;	restobuccalformid = "restobuccal" + toothnumber;	restomesialformid = "restomesial" + toothnumber;	restolingualformid = "restolingual" + toothnumber;	restoocclusalformid = "restoocclusal" + toothnumber;		amaldistalformid = "amaldistal" + toothnumber;	amalbuccalformid = "amalbuccal" + toothnumber;	amalmesialformid = "amalmesial" + toothnumber;	amallingualformid = "amallingual" + toothnumber;	amalocclusalformid = "amalocclusal" + toothnumber;		compodistalformid = "compodistal" + toothnumber;	compobuccalformid = "compobuccal" + toothnumber;	compomesialformid = "compomesial" + toothnumber;	compolingualformid = "compolingual" + toothnumber;	compoocclusalformid = "compoocclusal" + toothnumber;		glassdistalformid = "glassdistal" + toothnumber;	glassbuccalformid = "glassbuccal" + toothnumber;	glassmesialformid = "glassmesial" + toothnumber;	glasslingualformid = "glasslingual" + toothnumber;	glassocclusalformid = "glassocclusal" + toothnumber;		fillingdistalformid = "fillingdistal" + toothnumber;	fillingbuccalformid = "fillingbuccal" + toothnumber;	fillingmesialformid = "fillingmesial" + toothnumber;	fillinglingualformid = "fillinglingual" + toothnumber;	fillingocclusalformid = "fillingocclusal" + toothnumber;		postcorecrownformid = "postcore" + toothnumber;	porcelainfusedformid = "porcelainfused" + toothnumber;	acryliccrownformid = "acrylic" + toothnumber;	metalcrownformid = "metal" + toothnumber;	porcelaincrownformid = "porcelain" + toothnumber;		rootcanalformid = "rootcanal" + toothnumber;	pitfissureformid = "pitfissure" + toothnumber;	removablepartialformid = "removablepartial" + toothnumber;	fixedbridgeformid = "fixedbridge" + toothnumber;		extrusionformid = "extrusion" + toothnumber;	intrusionformid = "intrusion" + toothnumber;		extractedformid = "extracted" + toothnumber;		mesialdriftformid = "mesialdrift" + toothnumber;	distaldriftformid = "distaldrift" + toothnumber;	rotationformid = "rotation" + toothnumber;		restorableformid = "restorable" + toothnumber;	nonrestorableformid = "nonrestorable" + toothnumber;		cariesformid = "caries" + toothnumber;	recurrentformid = "recurrentcaries" + toothnumber;	amalgamformid = "amalgam" + toothnumber;	compositeformid = "composite" + toothnumber;	glassformid = "glassionomer" + toothnumber;	fillingformid = "tempfilling" + toothnumber;		cariessurfaceid = "caries_surfaces" + toothnumber;	recurrentsurfaceid = "recurrent_surfaces" + toothnumber;	amalgamsurfaceid = "amalgam_surfaces" + toothnumber;	compositesurfaceid = "composite_surfaces" + toothnumber;	glasssurfaceid = "glass_surfaces" + toothnumber;	fillingsurfaceid = "filling_surfaces" + toothnumber;		missingformid = "missing" + toothnumber;	uneruptedformid = "unerupted" + toothnumber;	impactedformid = "impacted" + toothnumber; 
		cariesSelectDistalid="cariesSelectDistal"+toothnumber;
		dentalstatussurfaceid="dentalstatussurface"+toothnumber; dentalstatusformid="dentalStatus"+toothnumber; alltoothsurfaceid="all_tooth_surfaces"+toothnumber; alltoothformid="alltooth"+toothnumber; restoreSelectSurfaceid="restoreSelectSurface"+toothnumber; restorationformid= "restoration"+toothnumber; restorationsurfaceid = "restoration_surfaces" + toothnumber; } 
		function showCaries() {	if(document.getElementById(cariesformid).checked == true) {		document.getElementById(cariessurfaceid).style.display = "block";	}	else if(document.getElementById(cariesformid).checked == false) {		document.getElementById(cariessurfaceid).style.display = "none";		document.getElementById(distalformid).checked = false;		document.getElementById(buccalformid).checked = false;		document.getElementById(mesialformid).checked = false;		document.getElementById(lingualformid).checked = false;		document.getElementById(occlusalformid).checked = false;		deleteThis('caries');	}}
		function showCaries2() {	if(document.getElementById(cariesformid).checked == true) {		document.getElementById(cariessurfaceid).style.display = "block";	}	else if(document.getElementById(cariesformid).checked == false) {		document.getElementById(cariessurfaceid).style.display = "none";		document.getElementById(distalformid).checked = false;		document.getElementById(buccalformid).checked = false;		document.getElementById(mesialformid).checked = false;		document.getElementById(lingualformid).checked = false;		document.getElementById(occlusalformid).checked = false;		deleteThis('caries');	}}
		function showRecurrent() {	if(document.getElementById(recurrentformid).checked == true) {		document.getElementById(recurrentsurfaceid).style.display = "block";	}	else if(document.getElementById(recurrentformid).checked == false) {		document.getElementById(recurrentsurfaceid).style.display = "none";		document.getElementById(redistalformid).checked = false;		document.getElementById(rebuccalformid).checked = false;		document.getElementById(remesialformid).checked = false;		document.getElementById(relingualformid).checked = false;		document.getElementById(reocclusalformid).checked = false;		deleteThis('recurrent');	}}
		function showAmalgam() {	if(document.getElementById(amalgamformid).checked == true) {		document.getElementById(amalgamsurfaceid).style.display = "block";	}	else if(document.getElementById(amalgamformid).checked == false) {		document.getElementById(amalgamsurfaceid).style.display = "none";				document.getElementById(amaldistalformid).checked = false;		document.getElementById(amalbuccalformid).checked = false;		document.getElementById(amalmesialformid).checked = false;		document.getElementById(amallingualformid).checked = false;		document.getElementById(amalocclusalformid).checked = false;		deleteThis('amalgam');	}}
		function showComposite() {	if(document.getElementById(compositeformid).checked == true) {		document.getElementById(compositesurfaceid).style.display = "block";	}	else if(document.getElementById(compositeformid).checked == false) {		document.getElementById(compositesurfaceid).style.display = "none";		document.getElementById(compodistalformid).checked = false;		document.getElementById(compobuccalformid).checked = false;		document.getElementById(compomesialformid).checked = false;		document.getElementById(compolingualformid).checked = false;		document.getElementById(compoocclusalformid).checked = false;		deleteThis('composite');	}}
		function showGlassionomer() {	if(document.getElementById(glassformid).checked == true) {		document.getElementById(glasssurfaceid).style.display = "block";	}	else if(document.getElementById(glassformid).checked == false) {		document.getElementById(glasssurfaceid).style.display = "none";		document.getElementById(glassdistalformid).checked = false;		document.getElementById(glassbuccalformid).checked = false;		document.getElementById(glassmesialformid).checked = false;		document.getElementById(glasslingualformid).checked = false;		document.getElementById(glassocclusalformid).checked = false;		deleteThis('glass');	}}
		function showTempfilling() {	if(document.getElementById(fillingformid).checked == true) {		document.getElementById(fillingsurfaceid).style.display = "block";	}	else if(document.getElementById(fillingformid).checked == false) {		document.getElementById(fillingsurfaceid).style.display = "none";		document.getElementById(fillingdistalformid).checked = false;		document.getElementById(fillingbuccalformid).checked = false;		document.getElementById(fillingmesialformid).checked = false;		document.getElementById(fillinglingualformid).checked = false;		document.getElementById(fillingocclusalformid).checked = false;		deleteThis('filling');	}}
...
var listofTNs = new Array();
		...
		function newArray() {	var heyarray = new Array();	return heyarray;}
		function setIndex(TN) {	if(TN > 10 && TN < 19) {		index = 18-TN;	}	else if(TN > 20 && TN < 29) {		index = TN-13;	}	else if(TN > 40 && TN < 49) {		index = (48-TN)+16;	}	else if(TN > 30  && TN < 39) {		index = TN-7;	}	}
		function checkTNs(TN) {	var count = 0;		for(var i = 0; i < listofTNs.length; i++) {		if(listofTNs[i] == TN)			count++;		else break;	}	if(count == listofTNs.length)		listofTNs.push(TN);	}	
function drawCondition(condition, position, TN) {
	...
	for(var r = 0; r < positions.length; r++) {
		...
		function drawConditionMini(condition, position, tn) { drawCondition(condition, position, tn);	redrawWidget(); if(condition=='caries' && position=='mesial'){hideCariesMesial();}else if(condition=='caries' && position=='distal'){ hideCariesDistal();} else if(condition=='caries' && position=='occlusal'){hideCariesOcclusal();} else if(condition=='caries' && position=='lingual'){hideCariesLingual();}else if(condition=='caries' && position=='buccal'){ hideCariesBuccal();} else if(condition=='recurrent' && position=='mesial'){hideReMesial();} else if(condition=='recurrent' && position=='distal'){hideReDistal();} else if(condition=='recurrent' && position=='occlusal'){hideReOcclusal();} else if(condition=='recurrent' && position=='lingual'){hideReLingual();} else if(condition=='recurrent' && position=='buccal'){hideReBuccal();}else if(condition=='restoration' && position=='mesial'){hideRestoreMesial();}else if(condition=='restoration' && position=='distal'){ hideRestoreDistal();} else if(condition=='restoration' && position=='occlusal'){hideRestoreOcclusal();}else if(condition=='restoration' && position=='lingual'){ hideRestoreLingual();}else if(condition=='restoration' && position=='buccal'){ hideRestoreBuccal();} } 
		function drawCondition2(condition,TN) {	if(condition == 'extrusion') {		drawExtrusion(62, 65, ctxmini11); hideOtherExtrusion();	}	else if(condition == 'intrusion') {		drawIntrusion(62, 65, ctxmini7); hideOtherIntrusion();	}	else if(condition == 'mesialdrift') {		drawMesialdrift(62, 65, ctxmini8); 	hideOtherMesialDrift();}	else if(condition == 'distaldrift') {		drawDistaldrift(62, 65, ctxmini9); hideOtherDistalDrift();	}	else if(condition == 'rotation') {		drawRotation(62, 65, ctxmini10); hideOtherRotation();	}	else if(condition == 'pitfissure') {		drawPitfissure(62, 65, ctxmini6); 	}	else if(condition == 'extracted') {	 drawExtracted(62, 65, ctxmini12); hideOtherExtracted();	}	else if(condition == 'missing') {		drawMissing(62, 65, ctxmini13); hideOtherMissing();	}	else if(condition == 'unerupted') {		drawUnerupted(62, 65, ctxmini14); hideOtherUnerupted();	}	else if(condition == 'impacted') {		drawImpacted(62, 65, ctxmini15); 	hideOtherImpacted();}	else if(condition == 'restorable') {		drawRestorable(62, 65, ctxmini16); 	}	else if(condition == 'nonrestorable') {		drawNonrestorable(62, 65, ctxmini17); 	}else if(condition == 'acrylic') {		drawAcrylic(TN); 	}else if(condition == 'postcore') {		drawPostCore(TN); 	}else if(condition == 'metal') {		drawMetal(TN); 	}else if(condition == 'porcelain') {		drawPorcelain(TN); 	}else if(condition == 'removablepartial') {		drawRPD(TN); 	}else if(condition == 'fixedbridge') {		drawFixedBridge(TN); 	}else if(condition == 'rootcanal') {		drawRootCanal(TN); 	}else if(condition == 'porcelainfused') {		drawPorcelainFused(TN); 	}else if(condition == 'pitfissure') {		drawPitFissure(TN); 	}}
		function drawConditionMini2(condition, TN) {
			drawCondition2(condition, TN);
			redrawWidget();
		}
		
		function drawConditionMini3(condition, TN) { hideOtherStandard(condition);	//drawCondition3(condition, TN);	
		clearContext3(62, 65, ctxmini2, ctxmini5);	drawCrowns(62, 65, ctxmini2, ctxmini5);}
		function drawCondition3(condition, TN) { hideOtherStandard(condition);		setIndex(TN);	var formid;	for(var i = 0; i < otherConds.length; i++) {		if(otherConds[i] == condition) { 		formid = otherFormIds[i];			if(document.getElementById(otherFormIds[i]).checked == true)  {					thisarray2[index].push(formid);				arrayFillColor2[index].push(colors2[i]);			}			else if(document.getElementById(otherFormIds[i]).checked == false) {								for(var i=0; i<thisarray2[index].length; i++) {					if(thisarray2[index][i] == formid) {						thisarray2[index].splice(i, 1);						arrayFillColor2[index].splice(i, 1);					}				}			}			break;		}	}}
		function clearContext(x, y, ctx) {		ctx.clearRect(x-40,y-40,77,77);}
		function clearContext2(x, y, ctx) {		ctx.clearRect(x-15, y-15, 50, 50);	}
		function clearContext3(x, y, ctx1, ctx2) {	ctx1.clearRect(x-40,y-40,77,77);	ctx2.clearRect(x-15, y-15, 50, 50);				}
...
function drawEverything(x, y, ctxmini1) {
	for(var i = 0; i < thisarray[index].length-1; i++) {
		...
		function initializevars() {	arrayA = [0.75, 1.25, 1.75, 2.25, 0];	arrayB = [1.25, 1.75, 2.25, 2.75, 2]; 	conditions = ["caries", "recurrent", "restoration"];	conditions2 = ["postcore", "removablepartial", "fixedbridge", "rootcanal", "porcelainfused", "acrylic", "metal", "porcelain"];	colors = ["red", "#67D413", "blue"];	colors2 = ["orange", "#00868B", "#FFA07A", "#00008B", "#CAFF70", "#97FFFF", "#555555", "#9400D3", "#00868B", "#FFA07A"];	positions = ["distal", "buccal", "mesial", "lingual", "occlusal"];	arrayfi1 = [distalformid, redistalformid, restodistalformid];	arrayfi2 = [buccalformid, rebuccalformid, restobuccalformid];	arrayfi3 = [mesialformid, remesialformid, restomesialformid];	arrayfi4 = [lingualformid, relingualformid, restolingualformid];	arrayfi5 = [occlusalformid, reocclusalformid, restoocclusalformid];	arrayFormIds = [arrayfi1,arrayfi2,arrayfi3,arrayfi4,arrayfi5];	otherFormIds = [rootcanalformid, removablepartialformid, fixedbridgeformid, porcelainfusedformid, postcorecrownformid, acryliccrownformid, metalcrownformid, porcelaincrownformid]; 	otherConds = ["rootcanal", "removablepartial", "fixedbridge", "porcelainfused", "postcore", "acrylic", "metal", "porcelain"];}
		function deleteThis(condition) { var ind;	for(var i = 0; i < conditions.length; i++) {		if(conditions[i] == condition) {			ind = i;		}	}	for(var i = 0; i < thisarray[index].length; i++) {			for(var j = 0; j < thisarray[index][i].length; j++) {			if(thisarray[index][i][j] == arrayFormIds[i][ind]) {				thisarray[index][i].splice(j, 1);				break;			}		}	}		redrawWidget();}
		function redrawWidget() {	clearContext(62, 65, ctxmini1);	clearContext2(62, 65, ctxmini4);	drawEverything(62, 65, ctxmini1);	drawOcclusals(62, 65, ctxmini4);}var layer1;var layer2;var layer3;var ctx1;var ctx2;var ctx3;var x = 400;var y = 300;var dx = 2;var dy = 4;var WIDTH = 400;var HEIGHT = 300;var city = new Image();
	...
	//	alert("boom");
		...
		function cancelcond(tn) {	thisID = 'light' + tn;	thisID2 = 'fade' + tn;	document.getElementById(thisID).style.display='none';document.getElementById(thisID2).style.display='none';}
		
		
		
		function initMini(tn) {	id = "layer1mini" + tn;	layermini1 = document.getElementById(id);	ctxmini1 = layermini1.getContext("2d");	layermini2 = document.getElementById("layer2mini" + tn);	ctxmini2 = layermini2.getContext("2d");	layermini3 = document.getElementById("layer3mini" + tn);	ctxmini3 = layermini3.getContext("2d");	layermini4 = document.getElementById("layer4mini" + tn);	ctxmini4 = layermini4.getContext("2d");	layermini5 = document.getElementById("layer5mini" + tn);	ctxmini5 = layermini5.getContext("2d");	layermini6 = document.getElementById("layer6mini" + tn);	ctxmini6 = layermini6.getContext("2d");	layermini7 = document.getElementById("layer7mini" + tn);	ctxmini7 = layermini7.getContext("2d");	layermini8 = document.getElementById("layer8mini" + tn);	ctxmini8 = layermini8.getContext("2d");	layermini9 = document.getElementById("layer9mini" + tn);	ctxmini9 = layermini9.getContext("2d");	layermini10 = document.getElementById("layer10mini" + tn);	ctxmini10 = layermini10.getContext("2d");	layermini11 = document.getElementById("layer11mini" + tn);	ctxmini11 = layermini11.getContext("2d");	layermini12 = document.getElementById("layer12mini" + tn);	ctxmini12 = layermini12.getContext("2d");	layermini13 = document.getElementById("layer13mini" + tn);	ctxmini13 = layermini13.getContext("2d");	layermini14 = document.getElementById("layer14mini" + tn);	ctxmini14 = layermini14.getContext("2d");	layermini15 = document.getElementById("layer15mini" + tn);	ctxmini15 = layermini15.getContext("2d");	layermini16 = document.getElementById("layer16mini" + tn);	ctxmini16 = layermini16.getContext("2d");	layermini17 = document.getElementById("layer17mini" + tn);	ctxmini17 = layermini17.getContext("2d");			drawTooth(ctxmini3);}
		
		function toothclick(tn) {
			 initMini(tn);
	 		thisID = 'light' + tn;	thisID2 = 'fade' + tn;	
			document.getElementById(thisID).style.display='block';
			document.getElementById(thisID2).style.display='block';	toothnumber = tn;
			getFormid(toothnumber);	initializevars();hideAllTooth(); 
			showAllTooth();  
			hideOtherExtracted();
			hideOtherMissing(); 
			hideOtherUnerupted();
		...
		hideOtherCaries(); hideOtherReccurent(); hideOtherRestoration(); 
		hideCariesInit();
		hideRecurrentInit();
		hideRestoreInit();
		setIndex(tn);	
...
var width1 = 70;
	var width2 = 30;
		var space1 = 5;	var space2 = 45;	var space3 = 75;
		var lineX1 = x1-25;	var lineY1 = 40;	var lineX2 = x1+25;	var lineY2 = 90;		
		var verticalSpace = 120;	var counter1 = 0;	var counter2 = 0;			
		for (counter1=0; counter1<16; counter1++) {				
		ctx33.lineWidth="1.5";						ctx33.beginPath();		
		ctx33.arc(x1,y1+verticalSpace,width1/2,0,Math.PI*2,false);		
		ctx33.closePath();		ctx33.strokeStyle="#000";		ctx33.stroke();		
		ctx33.beginPath();		ctx33.arc(x1,y1+verticalSpace,width2/2,0,Math.PI*2,false);	
		ctx33.closePath();		ctx33.strokeStyle="#000";		ctx33.stroke();				
